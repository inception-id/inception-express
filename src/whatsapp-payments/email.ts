export const createPaymentEmailTemplate = (email: string, amount: number) => {
  const template = `
    <!DOCTYPE html>
														...
														<tr>
															<td class="pad">
																<div style="color:#444a5b;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:19px;">
																	<p style="margin: 0; margin-bottom: 16px;">This is a reminder for your previous month <strong>Whatsapp API </strong>Payment billing has been auto generated.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Total Amount: <strong>Rp ${amount}</strong></p>
																	<p style="margin: 0;">Kindly login to your Inception account and click the Payment tab to see details, or</p>
																</div>
															</td>
														</tr>
													</table>
    ...
    <![endif]--><span class="button" style="background-color: #7747ff; mso-shading: transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: 400; mso-border-alt: none; padding-bottom: 5px; padding-top: 5px; padding-left: 20px; padding-right: 20px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span style="word-break: break-word; line-height: 32px;">Click Here to redirect</span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></a></div>
													...
													<table class="paragraph_block block-4" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="color:#444a5b;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:19px;">
																	<p style="margin: 0; margin-bottom: 16px;">If you are paying with certain Virtual Account, our name might still be showing with <em>Kontenku </em>(our previous brand name before <em>Inception).</em></p>
																	<p style="margin: 0;">This is an auto generated message from Inception.id</p>
																</div>
															</td>
														</tr>
													</table>
